...
<input type="hidden" id="croph" name="croph" value="560">
	...
	<div class="main">
		<div class="container">
			<div class="col-xs-12 col-md-3" id="avaterPic">
				<div class="avaterPic">
				...
				<div class="memberDetail">
					<div class="col-xs-12 col-sm-6 memberDetailLeft">
						<div class="detailItem" id="memberName">
							...
							<input type="text" id="memberNameInput" value="<?php echo $memberName;?>" maxlength="10" style="display:none;">
						</div>
					...
					<div class="col-xs-12 col-sm-6 memberDetailRight">
						...
						<div class="detailItem" id="memberIntroArea">
							...
							<textarea id="memberDescriptionInput" name="memberDescriptionInput" maxlength="200" style="display:none;"><?php echo $memberDescriptionTextarea;?></textarea>
						</div>
					</div>
				</div>
...
<div class="remindArea" id="popover_content_wrapper">
	...
	<div class="remindBottom"><a href="chatboard/<?php echo $mid;?>">更多留言</a></div>
</div>
